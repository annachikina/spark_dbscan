...
import org.apache.spark.dbscan.{TempPointId, ClusterId}

/** A subclass of [[org.apache.spark.dbscan.spatial.Point]] used during calculation of clusters within one partition
  *
  * @param p
  */
