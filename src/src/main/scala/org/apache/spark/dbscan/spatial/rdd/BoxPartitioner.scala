...
import org.apache.spark.dbscan.spatial.{PointSortKey, Point, Box}
import org.apache.spark.dbscan.BoxId

/** A partitioner which assigns each entry in a dataset to a [[org.apache.spark.dbscan.spatial.Box]]
  *
  * @param boxes A collection of [[org.apache.spark.dbscan.spatial.Box]]es
  */
