...
import org.apache.spark.dbscan.spatial.{DistanceAnalyzer, Point}
import org.apache.spark.dbscan.spatial.rdd.PointsPartitionedByBoxesRDD

/** Represents results calculated by DBSCAN algorithm.
  *
  * This object is returned from [[org.apache.spark.dbscan.Dbscan.run]] method.
...
val settings: DbscanSettings)
  ...
  /** Predicts which cluster a point would belong to
    *
    * @param newPoint A [[org.apache.spark.dbscan.PointCoordinates]] for which you want to make a prediction
    ...
    *         [[org.apache.spark.dbscan.DbscanModel.NoisePoint]] is returned.
    *         If the point is surrounded by so many noise points that they can constitute a new
    *         cluster, then [[org.apache.spark.dbscan.DbscanModel.NewCluster]] is returned
    */
...
object DbscanModel extends Loader[DbscanModel] {
  ...
  /** Indicates that a new cluster would appear in a [[org.apache.spark.dbscan.DbscanModel]] if
