...
import org.apache.spark.dbscan.spatial.rdd.{PointsInAdjacentBoxesRDD, PointsPartitionedByBoxesRDD, PartitioningSettings}
import scala.Some
import org.apache.spark.dbscan.util.commandLine.CommonArgs
import org.apache.spark.dbscan.util.debug.DebugHelper
...
/** Implementation of the DBSCAN algorithm which is capable of parallel processing of the input data.
  ...
  *
  * @param settings Parameters of the algorithm. See [[org.apache.spark.dbscan.DbscanSettings]]
  *                 for details
  * @param partitioningSettings Partitioning settings. See [[org.apache.spark.dbscan.spatial.rdd.PartitioningSettings]]
  *                             for details
  */
class DistributedDbscan (
   ...
   *
   * @param data A data set to be clustered. See [[org.apache.spark.dbscan.RawDataSet]] for details
   * @return A [[org.apache.spark.dbscan.DbscanModel]] object which represents clustering results
   */
  ...
  /** Finds clusters within one partition
    ...
    *           when this method is called, [[org.apache.spark.dbscan.spatial.Point]] objects in the collection
    *           already contain all necessary metadata, including number of their neighbors
    *
    * @param boundingBox A [[org.apache.spark.dbscan.spatial.Box]] object which represents bounds of the whole dataset
