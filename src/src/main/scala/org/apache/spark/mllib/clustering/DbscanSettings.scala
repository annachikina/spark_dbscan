...
class DbscanSettings extends Serializable {
  private var _distanceMeasure: distance.DistanceMeasure = DbscanSettings.getDefaultDistanceMeasure
  ...
  /** A distance measure
    ...
    * @return
    */
  def distanceMeasure: distance.DistanceMeasure = _distanceMeasure
  ...
  /** Sets a distance measure
    ...
    */
  def withDistanceMeasure (dm: distance.DistanceMeasure) = {
    _distanceMeasure = dm
    this
  }
...
object DbscanSettings {
  def getDefaultDistanceMeasure: distance.DistanceMeasure = new EuclideanDistance()
