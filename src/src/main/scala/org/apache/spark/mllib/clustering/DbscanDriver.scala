...
import org.apache.spark.mllib.clustering.util.debug.{Clock, DebugHelper}
import org.apache.spark.mllib.clustering.util.io.IOHelper
...
//  private [dbscan]
  class Args (var minPts: Int = DbscanSettings.getDefaultNumberOfPoints,
...
//  private [dbscan]
  class ArgsParser
    extends CommonArgsParser (new Args(DbscanSettings.getDefaultNumberOfPoints,
      DbscanSettings.getDefaultTreatmentOfBorderPoints), "DBSCAN clustering algorithm")
