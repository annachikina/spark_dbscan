...
import org.apache.spark.mllib.clustering.spatial.{DistanceAnalyzer, DistanceCalculation, Point, PointSortKey}
...
//  private [dbscan]
  class Args extends CommonArgs with NumberOfBucketsArg with NumberOfPointsInPartitionArg
...
//  private[dbscan]
  def calculateDistancesToNearestNeighbors(
