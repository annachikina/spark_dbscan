...
import org.apache.spark.mllib.clustering.util.io.IOHelper
import org.apache.spark.mllib.clustering.DbscanSettings
import ExploratoryAnalysisHelper._
import org.apache.spark.mllib.clustering.DbscanSettings
import org.apache.spark.mllib.clustering.spatial.rdd.{PartitioningSettings, PointsPartitionedByBoxesRDD}
import org.apache.spark.mllib.clustering.util.commandLine.{EpsArg, EpsArgParsing, NumberOfBucketsArg, NumberOfPointsInPartitionArg, NumberOfPointsInPartitionParsing}
import org.apache.spark.mllib.clustering.util.io.IOHelper
import org.apache.spark.mllib.clustering.util.commandLine._
import org.apache.spark.mllib.clustering.spatial.DistanceAnalyzer
import org.apache.spark.mllib.clustering.spatial.rdd.{PartitioningSettings, PointsPartitionedByBoxesRDD}
import org.apache.spark.mllib.clustering.util.debug.Clock
import org.apache.spark.mllib.clustering.RawDataSet
import org.apache.spark.mllib.clustering.DbscanSettings
import org.apache.spark.mllib.clustering.spatial.rdd.{PartitioningSettings, PointsPartitionedByBoxesRDD}
import org.apache.spark.mllib.clustering.util.commandLine.{EpsArg, EpsArgParsing, NumberOfBucketsArg, NumberOfPointsInPartitionArg, NumberOfPointsInPartitionParsing}
import org.apache.spark.mllib.clustering.util.io.IOHelper
...
//  private [dbscan]
  class Args extends CommonArgs with NumberOfBucketsArg with EpsArg with NumberOfPointsInPartitionArg
