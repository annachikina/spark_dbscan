...
import org.apache.spark.mllib.clustering.spatial.{BoxCalculator, Box}
import org.apache.spark.mllib.clustering.{PairOfAdjacentBoxIds, BoxId}

/** Partitions an [[org.apache.spark.mllib.clustering.spatial.rdd.PointsInAdjacentBoxesRDD]] so that each partition
