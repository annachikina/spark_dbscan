...
import org.apache.spark.mllib.clustering.spatial.rdd.PointsPartitionedByBoxesRDD
...
//  private [dbscan]
  val DefaultNumberOfBucketsInHistogram = 16

//  private [dbscan]
  implicit def toRDDWithLongIndexesAndDoubleValues (
