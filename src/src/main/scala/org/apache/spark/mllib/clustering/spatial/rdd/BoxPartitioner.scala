...
import org.apache.spark.mllib.clustering.spatial.{Box, Point, PointSortKey}
import org.apache.spark.mllib.clustering.BoxId
import org.apache.spark.mllib.clustering.spatial.{Box, PointSortKey}

/** A partitioner which assigns each entry in a dataset to a [[org.apache.spark.mllib.clustering.spatial.Box]]
  *
  * @param boxes A collection of [[org.apache.spark.mllib.clustering.spatial.Box]]es
  */
//private [dbscan]
