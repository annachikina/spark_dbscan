...
import org.apache.spark.mllib.clustering.util.commandLine.{CommonArgs, CommonArgsParser}
import org.apache.commons.math3.ml.distance.{EuclideanDistance, ManhattanDistance}
import org.apache.spark.mllib.clustering.util.commandLine.{CommonArgs, CommonArgsParser}
...
//    println("args:", args)
//    println("parsingResult:", parsingResult)
...
//    println(parser.args.masterUrl, masterUrl)
//    println(parser.args.jar, jar)
//    println(parser.args.inputPath, inputPath)
//    println(parser.args.outputPath, outputPath)
  }
